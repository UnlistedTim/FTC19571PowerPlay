...
@TeleOp(name = "WorldPower", group = "A")

public class WorldPower extends LinearOpMode {
...
//    private DistanceSensor cam_distance;
 ...
 //   Pose2d clocation;
  ...
  //Acceleration gravity; //added
    ...
    int[] outtake_heights = {-990, -1820,-2210, -2640};//
    int outtake_up_gap = -300; // after releasing cone raise slide up extra distance
  ...
  //  int intake_gap = -140; // after intake gap to raise linear slide
    int[] slidespeed = {0, 1800, 2300, 2600};//lineardlides different speed.
...
// manual release the cone.
    ...
    private void stackcone(){ // auto pick up the stacked cones pile
...
//        cam_distance = hardwareMap.get(DistanceSensor.class, "cam_distance");
        ...
        while (opModeIsActive()) {
           ...
           double frontRightPower = (y - x - rx) / denominator;
            ...
            if (manual) speed_mult=0.4;// for outtake maunal adjustment the rob location
